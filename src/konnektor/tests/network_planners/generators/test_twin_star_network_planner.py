...
def test_twin_star_network_planner():
    ...
    planner = TwinStarNetworkGenerator(mappers=empty_mapper, scorer=random_scorer)
    ...
    np.testing.assert_allclose(get_network_score(ligand_network), 14.659019, rtol=0.01)

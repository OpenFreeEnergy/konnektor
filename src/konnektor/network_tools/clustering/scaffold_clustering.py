...
class ScaffoldClusterer(_AbstractClusterer):
    ...
    def find_solution(
        ...
        for i in range(1, len(candidate_scaffolds)):
            ...
            if solutions:
                ...
                return solution
        # TODO: no final return statement here - decide how to handle not finding a solution
    ...
    def formulate_answer(
        ...
        solution : list[tuple[str, int]]
            Solution scaffolds, such as those generated by ScaffoldClusterer.find_solution().
        mols_to_norm : dict[Component, Chem.Mol]

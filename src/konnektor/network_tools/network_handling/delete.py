...
def delete_transformation(network: LigandNetwork,
                          transformation: Union[LigandAtomMapping, tuple[
                              Component, Component], list[LigandAtomMapping]]) -> LigandNetwork:
    """
    ...
    elif isinstance(transformation, list) and all(isinstance(t, LigandAtomMapping) for t in transformation):
...
def delete_component(network: LigandNetwork,
                     component: Union[Component, list[Component]]) -> LigandNetwork:
    """
